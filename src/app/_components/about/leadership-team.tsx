      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            Meet the experienced professionals guiding Crossafrique Hydrogen&#39;s mission to transform Africa&#39;s energy landscape.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {leaders.map((leader, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1 text-gray-900 dark:text-white">{leader.name}</h3>
                <p className="text-emerald-600 dark:text-emerald-400 font-medium mb-3">{leader.title}</p>
                <p className="text-gray-700 dark:text-gray-300 mb-4">{leader.bio}</p>
                <div className="flex space-x-3">
                  <a href={leader.linkedin} className="text-gray-500 hover:text-emerald-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-colors">
                    <Linkedin className="w-5 h-5" />
                  </a>
                  <a href={leader.twitter} className="text-gray-500 hover:text-emerald-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-colors">
