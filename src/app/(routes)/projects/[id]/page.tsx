...
import { ArrowLeft, MapPin, Calendar, BarChart, Users, Lightbulb } from "lucide-react";
  ...
  const projects = [
    {
      ...
      category: "Production",
      capacity: "10 MW",
      partners: ["Rwanda Energy Group", "African Development Bank", "Green Hydrogen Systems"],
      keyFeatures: [
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <div className="lg:w-2/3">
            ...
            <motion.div
              ...
              className="mt-12"
            >
              <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Project Gallery</h2>
          ...
          <div className="lg:w-1/3">
            ...
            >
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">{project.capacity}</p>
                  </div>
                </div>
              </div>
                ...
                <ul className="space-y-2">
                  {project.keyFeatures.map((feature, index) => (
                    <li key={index} className="text-gray-700 dark:text-gray-300 flex items-start">
                      <span className="inline-block w-1.5 h-1.5 rounded-full bg-emerald-600 mt-2 mr-2"></span>
                      {feature}
                    </li>
                  ))}
                </ul>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 p-6 rounded-lg border border-emerald-100 dark:border-emerald-800">
                <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Interested in similar projects?</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  Contact our team to discuss how we can implement hydrogen solutions for your organization or community.
                </p>
                <Link href="/contact">
