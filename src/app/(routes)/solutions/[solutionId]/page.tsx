					...
					<div className="max-w-3xl mx-auto">
						...
						>
							<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
								...
								<p className="text-gray-700 dark:text-gray-300">
									We offer solutions ranging from small demonstration projects
									to large-scale industrial implementations. Our modular
									approach allows us to scale solutions according to your
									specific needs and to expand capacity over time as
									requirements grow.
								</p>
							</div>
							...
							<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
								...
								<p className="text-gray-700 dark:text-gray-300">
									Implementation timelines vary based on project scale and
									complexity. Small projects can be completed in 6-12 months,
									while larger implementations may take 18-36 months. We work
									with clients to develop realistic timelines and often
									implement solutions in phases to deliver benefits sooner.
								</p>
							</div>
							...
							<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
								...
								<p className="text-gray-700 dark:text-gray-300">
									We provide comprehensive post-implementation support,
									including operational training, maintenance services, remote
									monitoring, performance optimization, and system upgrades. Our
									support packages can be tailored to your specific needs and
							...
							<div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
								<h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">
									How do you ensure solutions are appropriate for local
									conditions?
								</h3>
								<p className="text-gray-700 dark:text-gray-300">
									We conduct thorough assessments of local conditions,
									resources, infrastructure, and requirements before designing
									solutions. Our team includes experts with deep understanding
									of African contexts, and we work closely with local
									stakeholders to ensure our solutions address specific
						...
						>
							...
							<div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
								<div className="p-6">
									...
									<p className="text-gray-700 dark:text-gray-300 mb-4">
										Hydrogen solutions for industrial processes, reducing
							...
							<div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
								<div className="p-6">
									...
									<p className="text-gray-700 dark:text-gray-300 mb-4">
										Hydrogen-based energy storage systems to balance renewable
							...
							<div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
								<div className="p-6">
									...
									<p className="text-gray-700 dark:text-gray-300 mb-4">
										Hydrogen fuel cell vehicles and refueling infrastructure for
