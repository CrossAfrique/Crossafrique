    ...
    const solutions: Solution[] = [
      {
        ...
        description: "Renewable-powered electrolysis systems to produce clean hydrogen for various applications.",
        ...
        detailedDescription: "Our green hydrogen production solutions utilize renewable energy sources such as solar, wind, and hydropower to produce hydrogen through water electrolysis. This process splits water molecules into hydrogen and oxygen without any carbon emissions. We offer a range of electrolysis technologies, including alkaline, PEM (Proton Exchange Membrane), and emerging solid oxide systems, tailored to specific project requirements and local conditions across Africa.",
        features: [
        ...
        caseStudies: [
          {
            ...
            location: "Morocco",
            description: "A 10 MW solar-powered electrolysis facility producing green hydrogen for industrial use and export.",
            image: "/images/case-studies/morocco-hydrogen.jpg"
          },
          {
            title: "Hybrid Wind-Solar Hydrogen Production",
            location: "South Africa",
            description: "A hybrid renewable energy system powering hydrogen production for mining operations.",
      ...
      },
      {
        ...
        description: "Hydrogen solutions for industrial processes, reducing emissions while maintaining productivity.",
        ...
        detailedDescription: "Our industrial hydrogen solutions enable businesses to reduce their carbon footprint while maintaining or improving productivity. We provide systems for direct hydrogen use in industrial processes, hydrogen-based heating, and combined heat and power applications. Our solutions are designed to integrate with existing industrial infrastructure, minimizing disruption while maximizing environmental and economic benefits.",
        features: [
        ...
        caseStudies: [
          {
            ...
            location: "Namibia",
            description: "Conversion of mining equipment from diesel to hydrogen fuel cells, reducing emissions and improving air quality.",
            image: "/images/case-studies/namibia-mining.jpg"
          },
          {
            title: "Food Processing Plant",
            location: "Kenya",
            description: "Implementation of hydrogen-based heating systems in a food processing facility, reducing carbon emissions by 80%.",
      ...
      },
      {
        ...
        description: "Hydrogen fuel cell vehicles and refueling infrastructure for clean transportation.",
        ...
        caseStudies: [
          {
            ...
            location: "Egypt",
            description: "Implementation of hydrogen fuel cell buses for public transportation, reducing emissions and noise in urban areas.",
            image: "/images/case-studies/egypt-buses.jpg"
          },
          {
            title: "Mining Logistics Fleet",
            location: "Ghana",
            description: "Conversion of heavy-duty mining logistics vehicles to hydrogen fuel cells, improving air quality and reducing operational costs.",
      ...
      },
      {
        ...
        description: "Hydrogen-based energy storage systems to balance renewable generation and provide grid stability.",
        ...
        caseStudies: [
          {
            ...
            location: "Cape Verde",
            description: "A hydrogen-based energy storage system enabling 100% renewable energy supply for an island community.",
            image: "/images/case-studies/cape-verde-microgrid.jpg"
          },
          {
            title: "Solar Farm Integration",
            location: "Tanzania",
            description: "Hydrogen storage system integrated with a utility-scale solar farm to provide dispatchable power and grid services.",
      ...
      },
      {
        ...
        description: "Hydrogen technologies for clean heating, cooling, and power in commercial and residential buildings.",
        ...
        caseStudies: [
          {
            ...
            location: "Nigeria",
            description: "Implementation of hydrogen fuel cell CHP system in a commercial office complex, reducing energy costs and emissions.",
            image: "/images/case-studies/nigeria-office-complex.jpg"
          },
          {
            title: "Eco-Tourism Resort",
            location: "Rwanda",
            description: "Hydrogen-based energy system for an off-grid eco-tourism resort, providing clean and reliable power and heating.",
      ...
      },
      {
        ...
        description: "Hydrogen and ammonia solutions for clean fertilizer production and agricultural operations.",
        ...
        caseStudies: [
          {
            ...
            location: "Ethiopia",
            description: "Small-scale green ammonia production facility using renewable energy to produce fertilizer for local farmers.",
            image: "/images/case-studies/ethiopia-fertilizer.jpg"
          },
          {
            title: "Agricultural Cooperative",
            location: "Senegal",
            description: "Comprehensive hydrogen solution for an agricultural cooperative, including machinery, processing, and fertilizer production.",
  ...
  if (!solution) {
    return (
      <div className="pt-24 pb-16 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="mb-8">The solution you are looking for does not exist or has been moved.</p>
        <Link href="/solutions">
          <Button>
    ...
    <div className="pt-16">
      <div className="bg-emerald-700 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Link href="/solutions" className="inline-flex items-center text-emerald-100 hover:text-white mb-6">
            <ArrowLeft className="mr-2 w-4 h-4" />
            Back to Solutions
          </Link>
          <motion.div
          ...
          >
            <div className="md:w-1/2">
              ...
              <p className="text-xl text-emerald-100 mb-8">{solution.description}</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white">Benefits</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              >
                Real-world examples of our {solution.title.toLowerCase()} in action.
              </motion.p>
            </div>
      ...
      <section className="py-16 bg-emerald-700 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Contact our team to discuss how our {solution.title.toLowerCase()} can address your specific needs and contribute to a cleaner, more sustainable future.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">
                  What scale of {solution.title.toLowerCase()} do you offer?
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  We offer solutions ranging from small demonstration projects to large-scale industrial implementations. Our modular approach allows us to scale solutions according to your specific needs and to expand capacity over time as requirements grow.
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Implementation timelines vary based on project scale and complexity. Small projects can be completed in 6-12 months, while larger implementations may take 18-36 months. We work with clients to develop realistic timelines and often implement solutions in phases to deliver benefits sooner.
                </p>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  We provide comprehensive post-implementation support, including operational training, maintenance services, remote monitoring, performance optimization, and system upgrades. Our support packages can be tailored to your specific needs and internal capabilities.
                </p>
              </div>
              
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">
                  How do you ensure solutions are appropriate for local conditions?
                </h3>
                <p className="text-gray-700 dark:text-gray-300">
                  We conduct thorough assessments of local conditions, resources, infrastructure, and requirements before designing solutions. Our team includes experts with deep understanding of African contexts, and we work closely with local stakeholders to ensure our solutions address specific challenges and opportunities.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              {/* This would ideally be dynamically generated based on related solutions */}
              <div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
                <div className="p-6">
                  ...
                  <Link href="/solutions/industrial-applications">
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
                <div className="p-6">
                  ...
                  <Link href="/solutions/energy-storage">
                    <Button variant="outline" className="w-full">Learn More</Button>
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg overflow-hidden shadow-md">
                <div className="p-6">
                  ...
                  <Link href="/solutions/mobility-solutions">
                    <Button variant="outline" className="w-full">Learn More</Button>
                  </Link>
                </div>
              </div>
