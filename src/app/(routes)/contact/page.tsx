    ...
    <div className="pt-16">
      <div className="bg-emerald-700 text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Get in touch with our team to discuss your hydrogen needs or to learn more about our solutions.
          </motion.p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 mb-8">
                Whether you have questions about our hydrogen solutions, want to explore partnership opportunities, or are ready to start a project, we&#39;re here to help.
              </p>
              ...
              <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-900 dark:text-white mb-1">South Africa</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                      456 Green Energy Street<br />
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-900 dark:text-white mb-1">Morocco</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                      789 Renewable Avenue<br />
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-900 dark:text-white mb-1">Nigeria</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                      321 Clean Energy Road<br />
                      Lagos, Nigeria<br />
                      +234 1 234 5678
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <h4 className="font-medium text-gray-900 dark:text-white mb-1">Egypt</h4>
                    <p className="text-gray-700 dark:text-gray-300 text-sm">
                      654 Hydrogen Boulevard<br />
                      Cairo, Egypt<br />
                      +20 2 1234 5678
                    </p>
                  </div>
      ...
      <section className="py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            >
              With offices across Africa, we&#39;re well-positioned to serve clients throughout the continent.
            </motion.p>
          </div>
      ...
      <section className="py-16 bg-emerald-700 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Stay updated with the latest news, insights, and developments in hydrogen technologies and our projects across Africa.
            </motion.p>
