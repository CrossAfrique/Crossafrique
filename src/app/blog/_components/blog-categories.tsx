	...
	const blogPosts = [
		{
			...
			excerpt:
				"How hydrogen fuel cell vehicles could revolutionize public transportation in Africa's rapidly growing cities.",
		...
		},
		{
			...
			excerpt:
				"Our research team has achieved a significant improvement in electrolysis efficiency, reducing the cost of green hydrogen production.",
		...
		},
		{
			...
			excerpt:
				"The African Union has launched a continent-wide initiative to promote hydrogen development and establish standards.",
		...
		},
		{
			...
			excerpt:
				"Announcing our new partnership with the Nigerian government to develop hydrogen infrastructure in the Niger Delta region.",
		...
		},
		{
			...
			excerpt:
				"Exploring how hydrogen can help reduce emissions in Africa's vital mining sector while improving operational efficiency.",
		...
		},
		{
			...
			excerpt:
				"Our scientists have developed a novel catalyst that significantly reduces the cost of hydrogen production from water electrolysis.",
